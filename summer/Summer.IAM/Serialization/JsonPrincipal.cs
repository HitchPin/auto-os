...
public record JsonPrincipal
{
    ...
    public StarrableArray AWS { get; private set; } = StarrableArray.Empty;
    public StarrableArray Service { get; private set; } = StarrableArray.Empty;
    public StarrableArray Federated { get; private set; } = StarrableArray.Empty;
    public StarrableArray CanonicalUser { get; private set; } = StarrableArray.Empty;
