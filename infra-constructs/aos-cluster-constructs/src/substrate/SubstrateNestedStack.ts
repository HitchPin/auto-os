...
interface ConfigAssetsProps extends BaseNestedStackProps {
  configBucketName: string,
  configPrefix: string,
}

export class SubstrateNestedStack extends BaseNestedStack {
  ...
  constructor(scope: Construct, id: string, props: ConfigAssetsProps) {
