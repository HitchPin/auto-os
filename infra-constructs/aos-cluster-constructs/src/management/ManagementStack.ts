...
interface ManagementStackProps extends BaseNestedStackProps {
  vpc: ec2.IVpc;
  ...
  invocationRepo: ecr.IRepository;
  invocationTag: string;
}

export class ManagementStack extends BaseNestedStack {
  ...
  constructor(scope: Construct, id: string, props: ManagementStackProps) {
    ...
    const invocation = new aosInternal.MaestroAdminInvocation(this, "GetRootExample", {
      ...
      invocationProjectRepo: props.invocationRepo,
      invocationProjectTag: props.invocationTag
    });
