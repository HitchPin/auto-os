import { aws_events as evts, aws_s3 as s3, aws_events_targets as targets, aws_iam as iam, aws_logs as logs, aws_sqs as sqs } from "aws-cdk-lib";
...
export class EventNotifications extends Construct {
  ...
  constructor(parent: Construct, name: string, props: EventNotificationsProps) {
    super(parent, name);
