...
import (
	...
	"github.com/HitchPin/providers/cluster-tls/rootca-cfn-resource/cmd/logging"
...
type hFunc func(request handler.Request) handler.ProgressEvent

// MakeEventFunc is the entry point to all invocations of a custom resource
func makeEventFunc(h H) eventFunc {
...
func router(a string, h H) (hFunc, cfnerr.Error) {
...
func invoke(handlerFn hFunc, request handler.Request, metricsPublisher *metrics.Publisher, action string) handler.ProgressEvent {
